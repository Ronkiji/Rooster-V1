...
function validateFormRegistration() {
	...
	$.post(url, data, null)
		.done(function() {
			window.location.href = "/RoosterOnEclispe/home.jsp";
			console.log("Fail at JS");
		})
		.fail(function() {
			if(document.getElementById('ruserpw').value !== document.getElementById('rconfirmpw').value){
	...
	console.log(document.getElementById('ruserpw').value);
	console.log(document.getElementById('rconfirmpw').value);
}
