...
//	console.log("We are in the getProjectArray loop");
//	var projectArray = '<%=session.getAttribute("projectArray")%>';
//	console.log(projectArray.length);
//	var Project = Java.type("com.rooster.type.Project");
//	var Object = Java.type("java.util.Objects");
//	var obj = new Object();
//	obj = '<%=session.getAttribute("projectArray")%>';
//	
////	'<%=session.getAttribute("projectArray")%>';
//;
